...
<body>
  ...
  <h3>Github</h3>
  <p>Github is a website that hosts and uses Git, allowing users to collaborate on open source projects (where the public can see the code), or closed source projects (where the public cannot see the code, but select users can). 
  <h2>Habitat</h2>
