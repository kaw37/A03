...
<body>
  ...
  <ul>
  <li>Open the terminal (an application that directly interacts with the computer through typed commands) to save the project to a certain place on the computer using the cd (change directory) command</li>
